    ...
    <div v-if="product.length > 0" class="flex justify-center items-center w-screen h-screen p-4">
      <form class="flex flex-col border-4 border-[#212844] w-[900px]">
        ...
        <div class="flex justify-between">
            <div class="flex flex-col px-5 w-full justify-between">
              ...
              <textarea v-model="product[0].description" class="border-[1px] border-[#212844] h-full rounded-lg p-2" id="editedDescription"></textarea>
