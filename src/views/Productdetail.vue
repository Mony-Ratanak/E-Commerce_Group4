    ...
    <div class="scroll flex flex-col">
      <div class="flex justify-center items-center pl-8 gap-48">
        ...
        <div class="flex justify-center border-[1px] border-[#0099FF] p-8 hover:bg-gray-200">
            <img class="w-fit h-96" :src="'http://127.0.0.1:8000/storage/' + product.images" alt="Product Image">
        </div>
      </div>
    ...
    methods: {
        async fetchProduct(productId) {
            ...
            try {
                ...
                const response = await axios.get('http://127.0.0.1:8000/api/getproductbyid', {
                    params: {
                        id: numericProductId,
                    },
                });
